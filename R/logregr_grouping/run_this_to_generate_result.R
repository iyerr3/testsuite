...
for (data.set in datasets) eval.logregr.append.results(
                                            data.set = data.set, 
                                            sql.path='~/Work/MADlib/testsuite/dataset/sql'                
                                        )
...
dat <- prepare.dataset("log_ornstein", sql.path = "~/Work/MADlib/testsuite/dataset/sql/", data.path = "../data/", py.path = "../utils/")
